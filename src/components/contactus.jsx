  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Helmet>
          <meta charSet="utf-8" />
          <title>Kloxet | Contact Us Page and Email Information</title>
          <meta name="earrings, bangles, necklaces" content="" />
          <meta name="Contact us now, send us a message" content="" />
        </Helmet>
